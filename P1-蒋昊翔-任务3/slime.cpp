...
void Slime::setAttack(int atk) {
    if (attack < atk) { // 如果攻击力大于基础值，说明使用了强攻药
...
bool Slime::getHasAttackPotion() { 
    return hasAttackPotion; 
}
    
void Slime::resetHasAttackPotion() {
    hasAttackPotion = false;
}