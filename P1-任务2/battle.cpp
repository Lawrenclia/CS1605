...
//任务2添加内容，如果敌人需要切换slime无法战斗，输出false
bool enemyChooseChange(std::ostream& os, Slime* &playSlime0, Slime* &playSlime1, std::vector<Slime*> &enemyTeam) {
    Slime* sameTypeSlime;
    bool haveSame = false;
    for (auto slime : enemyTeam) {
...
//进行上场slimes的互相攻击
void fight(std::istream& is, std::ostream& os, Slime* &playSlime0, SkillType userSkill, bool userAttack, bool enemyAttack, Slime* &playSlime1, SkillType enemySkill, 
...
void OneRound(std::istream& is, std::ostream& os, Slime* &playSlime0, Slime* &playSlime1,
    ...
    if (action == 1) {    // 选择技能
        ...
        bool enemyIsChange = enemyChooseChange(os, playSlime0, playSlime1, enemyTeam);
        SkillType userSkill = userChooseSkill(playSlime0, choose1);
        SkillType enemySkill = enemyChooseSkill(playSlime1, playSlime0);

        fight(is, os, playSlime0, userSkill, true, enemyIsChange, playSlime1, enemySkill, playerTeam, enemyTeam, isEnd);
        ...
        fight(is, os, playSlime0, userSkill, false, enemyIsChange, playSlime1, enemySkill, playerTeam, enemyTeam, isEnd);
